/* we will be hard coding the data for the web site like name address designation etc 
for now, we will develop a backend service in the near future for the transfer of the 
data form database to UI using REST calls from java application build using spring */
